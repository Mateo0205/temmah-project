      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-blue-500 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
            <strong>Envie de découverte</strong> lorem ipsum dolor
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi libero
            iure in fugit quas porro hic repellendus aliquid doloremque
            laudantium ducimus unde quos molestiae dolorem non, praesentium
            quidem blanditiis incidunt.
          </p>
          <Image
            src="/quote.svg"
            alt="camp-2"
